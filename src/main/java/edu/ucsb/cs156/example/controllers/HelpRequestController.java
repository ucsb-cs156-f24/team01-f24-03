...
public class HelpRequestController extends ApiController {
     ...
     * @param tableOrBreakoutRoom whether its at a table or breakout room
     * @param explanation     the details of request
     * @param solved          whether request has been solved or not
     * @param requestTime     the date and time of request in the format YYYY-mm-ddTHH:MM:SS
